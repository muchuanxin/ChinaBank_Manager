...
import com.xd.aselab.chinabankmanager.util.SlidingDrawerGridView;
...
//                                    post[0] = new PostParameter("member_account", member_info[0][position]);
                                    ...
                                    Log.d("member_account",map.get("account") + "");
                                    post[1] = new PostParameter("owner_account", sp.getAccount());
                                    Log.d("owner_account",sp.getAccount());
                                    ...
                                    Log.d("Dorise 12 16 gp owner",sp.getName());
                                    Log.d("Dorise 12 16 gp name",getIntent().getStringExtra("group_name"));


                                    Log.d("group_id",getIntent().getStringExtra("group_id") + "");
                                    String jsonStr = ConnectUtil.httpRequest(ConnectUtil.ExpelMemberFromGroup, post, "POST");
...
//
//        ImageLoader loader=ImageLoader.getInstance();
//        loader.loadBitmap(Group_info.this,getIntent().getStringExtra("head_image"),group_image,R.drawable.default_head);
...
Log.d("group_id 12 14",getIntent().getStringExtra("group_id"));
...
//                holder.name.setText(member_info[1][position]);
                ...
                loader.loadBitmap(Group_info.this, temp.get("head_image") + "", holder.image, R.drawable.default_photo);
            }
            return myview;
        }
