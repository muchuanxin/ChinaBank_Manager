...
public class MainActivity_Base extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageCycleView = (ImageCycleView) findViewById(R.id.act_main_base_ImageCycleView);
        ...
        mAdCycleViewListener = new ImageCycleView.ImageCycleViewListener() {
            ...
            public void displayImage(String imageURL, ImageView imageView) {
                if ("no_picture".equals(imageURL)){
                    ...
                    imageLoader.loadBitmap(MainActivity_Base.this, imageURL, imageView, 0);
                }
            }
        };
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 0 :
                        try {
                            ...
                            if (reCode!=null){
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(MainActivity_Base.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    Log.e("MyContact_Activity", MainActivity_Base.this.getResources().getString(R.string.status_exception));
                                }
                            }
                            else {
                                Toast.makeText(MainActivity_Base.this, MainActivity_Base.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    default:
                        Log.e("MyContact_Activity", MainActivity_Base.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };

        toast_i = (TextView) findViewById(R.id.act_main_base_toast_i);
        ...
        personal_info = (ImageView) findViewById(R.id.act_main_base_personal_info);
        personal_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(MainActivity_Base.this, PersonalInfo.class);
                startActivityForResult(intent, 196);
            }
        });

        my_management = (LinearLayout) findViewById(R.id.act_main_base_my_management);
        my_management.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(MainActivity_Base.this, MyManageBase.class);
                startActivity(intent);
            }
        });

        hot_recommend = (LinearLayout) findViewById(R.id.act_main_base_hot_recommend);
        hot_recommend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(MainActivity_Base.this, MainHotRecommenderActivity.class);
                startActivity(intent);
            }
        });

        china_bank_network = (LinearLayout) findViewById(R.id.act_main_base_china_bank_network);
        china_bank_network.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(MainActivity_Base.this, CBNetwork.class);
                startActivity(intent);
            }
        });

        china_bank_benefit = (LinearLayout) findViewById(R.id.act_main_base_china_bank_benefit);
        china_bank_benefit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(MainActivity_Base.this, ChinaBankBenefit.class);
                startActivity(intent);
            }
        });
    }
