...
public class GrabPerformanceActivity extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grab_performance);
...
//                        new AlertDialog.Builder(GrabPerformanceActivity.this)
//                                .setTitle("dayu0")
...
//                                .create().show();
                        ...
                        if (!flag) {
                            ...
                            Toast.makeText(GrabPerformanceActivity.this, "还没有业绩信息", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(GrabPerformanceActivity.this, "业绩信息已加载", Toast.LENGTH_SHORT).show();
                            initChartDatas();
                        ...
                        Toast.makeText(GrabPerformanceActivity.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                ...
                Toast.makeText(GrabPerformanceActivity.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
            }
        }
    };
            ...
            if (ConnectUtil.isNetworkAvailable(GrabPerformanceActivity.this)) {
                ...
                if (!myObj.getString("success_num").equals("0")) {
                    click.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(GrabPerformanceActivity.this, GrabPerformanceDetailActivity.class);
