...
public class KafenqiCustomerPerformance extends AppCompatActivity implements OnChartValueSelectedListener {

    private TextView customer_recommend_num;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kafenqi_customer_performance);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        }

        back = (RelativeLayout) findViewById(R.id.act_kafenqi_customer_perf_back_btn);
        ...
        customer_recommend_num = (TextView) findViewById(R.id.act_kafenqi_customer_perf_recommend_num_text);
        ...
        select_time = (TextView) findViewById(R.id.act_customer_perf_select_time);
    ...
    void getData() {
        new Thread() {
            ...
            public void run() {
                super.run();
                SharePreferenceUtil spu = new SharePreferenceUtil(KafenqiCustomerPerformance.this, "user");
                PostParameter[] parameter = new PostParameter[1];
                parameter[0] = new PostParameter("account", spu.getAccount());
                String recode = ConnectUtil.httpRequest(ConnectUtil.GetYoukeMyPerformance, parameter, ConnectUtil.POST);
                        ...
                        try {
                            ...
                            if(recode != null) {
                                ...
                                if("false".equals(status)) {
                                    Toast.makeText(KafenqiCustomerPerformance.this, object.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                    exchanged_score_one_year = oneYearJO.getInt(null);
                                    ...
                                    Log.e("KMyPreformenceActivity", KafenqiCustomerPerformance.this.getResources().getString(R.string.status_exception));
                                }
                            } else {
                                Toast.makeText(KafenqiCustomerPerformance.this, KafenqiCustomerPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                    ...
                    default:
                        Log.e("KMyPreformenceActivity", KafenqiCustomerPerformance.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
    ...
    void initDatas() {
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList,KafenqiCustomerPerformance.this);
    ...
    void showPopWindow() {
        View root = LayoutInflater.from(KafenqiCustomerPerformance.this).inflate(R.layout.choose_time_listview,null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_kafenqi_customer_performance), Gravity.TOP, 0, 0);
    ...
    private void setText(int recommend_num, double recommend_money, int success_num,double success_money,int total_score,int exchanged_score) {
        ...
        customer_recommend_num.setText("".equals(recommend_num)? "暂无" : recommend_num+"笔");
