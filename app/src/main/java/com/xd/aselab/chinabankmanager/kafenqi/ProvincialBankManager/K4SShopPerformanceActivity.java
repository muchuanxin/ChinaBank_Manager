...
public class K4SShopPerformanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_k4s_shop_performance);
    ...
    void initDatas(){
        spu = new SharePreferenceUtil(K4SShopPerformanceActivity.this, "user");
        secondary_num=(String) getIntent().getSerializableExtra("worker_account");
        secondary_name=(String) getIntent().getSerializableExtra("worker_name");
        select_string = new String[]{"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList,K4SShopPerformanceActivity.this);
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList,K4SShopPerformanceActivity.this);
    ...
    void getDataFormServer() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                        ...
                        try {
                            ...
                            if (reCode != null) {
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(K4SShopPerformanceActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    if (oneWeekJA.length() > 0) {
                                        for (int i = 0; i < oneWeekJA.length(); i++) {
                                            ...
                                            baseVO.setBase_account(temp.getString("4sshop_id"));
                                            baseVO.setBase_name(temp.getString("4sshop_name"));
                                    ...
                                    adapter = new BasePerfAdapter(base_list_one_week, K4SShopPerformanceActivity.this);
                                    ...
                                    Log.e("KMyPreformenceActivity", K4SShopPerformanceActivity.this.getResources().getString(R.string.status_exception));
                                }
                            } else {
                                Toast.makeText(K4SShopPerformanceActivity.this, K4SShopPerformanceActivity.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            if (reCode != null) {
                                ...
                                if ("false".equals(status)) {
                                    ...
                                    Toast.makeText(K4SShopPerformanceActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    base_list_one_week = new ArrayList<>();
                                    base_list_one_month = new ArrayList<>();
                                    base_list_three_month = new ArrayList<>();
                                    base_list_one_year = new ArrayList<>();
                                    getDataFormServer();
                                } else {
                                    Log.e("KMyPreformenceActivity", K4SShopPerformanceActivity.this.getResources().getString(R.string.status_exception));
                                }
                    ...
                    default:
                        Log.e("KMyPreformenceActivity", K4SShopPerformanceActivity.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String reCode = ConnectUtil.httpRequest(ConnectUtil.GetInstallment4SShopPerformace, params, ConnectUtil.POST);
                Log.e("reCode", "" + reCode);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
              ...
              Intent intent = new Intent();
                intent.setClass(K4SShopPerformanceActivity.this,K4SShopPerformanceDetailActivity.class);
                intent.putExtra("secondary_num",secondary_num);
                intent.putExtra("secondary_name",secondary_name);
                intent.putExtra("4sshop_id",worker_account);
                intent.putExtra("4sshop_name",worker_name);
             ...
             /*   startActivityForResult(new Intent().setClass(K4SShopPerformanceActivity.this,  BaseInfoTransparent.class).putExtra("position",position).putExtra("fromwhere","K4SShopPerformanceActivity"), 105);
    ...
    void showSortPopWindow(){
        View root = LayoutInflater.from(K4SShopPerformanceActivity.this).inflate(R.layout.choose_time_listview,null);
    ...
    protected  void onActivityResult(int requestCode, int resultCode, final Intent intent){
        if(141==resultCode){
            ...
            switch (select_time.getText().toString()){
                case "近一周业绩":
                    shop_id=base_list_one_week.get(i).getBase_account();
                    break;
                case "近一月业绩":
                    shop_id=base_list_one_month.get(i).getBase_account();
                    break;
                case "近一季度业绩":
                    shop_id=base_list_three_month.get(i).getBase_account();
                    break;
                case "近一年业绩":
                    shop_id=base_list_one_year.get(i).getBase_account();
                    break;

            }

           *//* Log.i("kmj","shop_id="+shop_id);
            Log.i("kmj","worker_account="+worker_account);*//*
            new Thread(){
                @Override
                public void run() {
                    super.run();
                    final PostParameter[] params = new PostParameter[2];
                    params[0] = new PostParameter("4sshop_id", shop_id);
                    params[1] = new PostParameter("secondary_num", worker_account);
