...
public class K4SShopPerformanceDetailActivity extends AppCompatActivity {
    ...
    private TextView qiangzhi_jieyue;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_k4s_shop_performance_detail);
    ...
    void initViews(){
        ...
        qiangzhi_jieyue = (TextView) findViewById(R.id.act_qiangzhi_jieyue);
    }

    void initDatas(){
        spu = new SharePreferenceUtil(K4SShopPerformanceDetailActivity.this,"user");
        secondary_num=getIntent().getStringExtra("secondary_num");
        secondary_name=getIntent().getStringExtra("secondary_name");
        range = "4S店"+getIntent().getStringExtra("range");
        worker_account = getIntent().getStringExtra("4sshop_id");
        worker_name = getIntent().getStringExtra("4sshop_name");
...
Log.i("kmj","secondary_num"+secondary_num);
    ...
    void getDataFormServer(){
                ...
                switch (msg.what){
                        ...
                        try {
                            ...
                            if (reCode!=null){
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(K4SShopPerformanceDetailActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    Log.e("KMyPreformenceActivity", K4SShopPerformanceDetailActivity.this.getResources().getString(R.string.status_exception));
                                }
                            }
                            else {
                                Toast.makeText(K4SShopPerformanceDetailActivity.this, K4SShopPerformanceDetailActivity.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                   ...
                   /* case 1:
                    ...
                    case 1:
                        ...
                        default:
                        Log.e("KMyPreformenceActivity", K4SShopPerformanceDetailActivity.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
        ...
        new Thread(){
            ...
            public void run() {
                ...
                params[1] = new PostParameter("4sshop_id", worker_account);
                String reCode = ConnectUtil.httpRequest(ConnectUtil.GetInstallmentWorkerPerformanceIn4SShop, params, ConnectUtil.POST);
                Log.e("reCode",""+reCode);
    ...
    void initEvent()
    {
       ...
       listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
        ...
        qiangzhi_jieyue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
