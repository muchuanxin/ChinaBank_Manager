...
public class KCustomerManagerPerformanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kcustomer_manager_performance);
    ...
    void initDatas() {
        spu = new SharePreferenceUtil(KCustomerManagerPerformanceActivity.this, "user");
        worker_account = (String) getIntent().getSerializableExtra("worker_account");
        select_string = new String[]{"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, KCustomerManagerPerformanceActivity.this);
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList, KCustomerManagerPerformanceActivity.this);
        intent = getIntent();
...
//            }
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case 0:
                            try {
                                ...
                                if (reCode != null) {
                                    ...
                                    if ("false".equals(status)) {
                                        Toast.makeText(KCustomerManagerPerformanceActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                        ...
                                        if (shijian!=null && !" ".equals(shijian)) {
                                            ...
                                            adapter = new BasePerfAdapter(temp, KCustomerManagerPerformanceActivity.this);
                                        }
                                        else{
                                        adapter = new BasePerfAdapter(base_list_one_week, KCustomerManagerPerformanceActivity.this);
                                       }
                                        ...
                                        Log.e("KMyPreformenceActivity", KCustomerManagerPerformanceActivity.this.getResources().getString(R.string.status_exception));
                                    }
                                } else {
                                    Toast.makeText(KCustomerManagerPerformanceActivity.this, KCustomerManagerPerformanceActivity.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                            ...
                            break;
                        default:
                            Log.e("KMyPreformenceActivity", KCustomerManagerPerformanceActivity.this.getResources().getString(R.string.handler_what_exception));
                            break;
                    }
                }
            };
    ...
    void initEvents(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(KCustomerManagerPerformanceActivity.this,KCustomerManagerPerformanceDetailActivity.class);
    ...
    void showTimePopWindow(){
        ...
        View root = LayoutInflater.from(KCustomerManagerPerformanceActivity.this).inflate(R.layout.choose_time_listview,null);
