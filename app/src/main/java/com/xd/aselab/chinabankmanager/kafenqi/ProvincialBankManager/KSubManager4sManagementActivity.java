...
/**
 * Created by wangyali on 2018/3/29.
 * 4s店销售业绩
 */

public class KSubManager4sManagementActivity extends AppCompatActivity {
    ...
    private String  base_fenqi_confirm_num="base_fenqi_num";//确认业务
    private String  base_fenqi_refuse_num="base_fenqi_num";//拒绝业务
    private String  base_fenqi_remark_num="base_fenqi_num";//备注业务
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ksubmanager_4smanagement);
    ...
    void initDatas(){
        spu = new SharePreferenceUtil(KSubManager4sManagementActivity.this, "user");
        select_string = new String[]{"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, KSubManager4sManagementActivity.this);
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortListcopy,KSubManager4sManagementActivity.this);
        handler = new Handler(){
            @Override
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 0 :
                        try {
                            ...
                            if (reCode!=null){
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(KSubManager4sManagementActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    adapter = new BasePerfToAdapter(base_list_one_week, KSubManager4sManagementActivity.this);
                                    ...
                                    Log.e("KMyPreformenceActivity", KSubManager4sManagementActivity.this.getResources().getString(R.string.status_exception));
                                }
                            }
                            else {
                                Toast.makeText(KSubManager4sManagementActivity.this, KSubManager4sManagementActivity.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    default:
                        Log.e("KMyPreformenceActivity", KSubManager4sManagementActivity.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
     ...
     //           int fenqi_recommend_num=0;
                ...
                switch (select_time.getText().toString()){
                    case "近一周业绩" :
                        ...
                        range = "近一周业绩";
                   //    fenqi_recommend_num=base_list_one_week.get(position).getBase_fenqi_recommend_num();
                ...
                intent.setClass(KSubManager4sManagementActivity.this,KSubManager4sManagementDetailActivity.class);

                intent.putExtra("worker_account",worker_account);
                intent.putExtra("worker_name",worker_name);
                intent.putExtra("range",range);
             //  intent.putExtra("fenqi_recommend_num",fenqi_recommend_num);
...
/*
    ...
    void showSortPopWindow(){
        View root = LayoutInflater.from(KSubManager4sManagementActivity.this).inflate(R.layout.choose_time_listview,null);
        ...
        lv_timeList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                sort.setText(Constants.shengHangChooseSortListcopy.get(position));
                switch (Constants.shengHangChooseSortListcopy.get(position)){
                    case "确认业务数量降序" :
                        choosen_sort=base_fenqi_confirm_num;
                        switch (choosen_time){
                            case "one_week":
                            ...
                            case "one_month":
                                ...
                                break;
                            case "three_month":
                                setListAndAdaper(base_list_three_month,"base_fenqi_confirm_num");
                                break;
                            case "one_year":
                                setListAndAdaper(base_list_one_year,"base_fenqi_confirm_num");
                                break;
                        }
                        break;
                    case "备注业务数量降序" :
                        choosen_sort=base_fenqi_remark_num;
                        switch (choosen_time){
                            case "one_week":
                            ...
                            case "one_month":
                                ...
                                break;
                            case "three_month":
                                setListAndAdaper(base_list_three_month,"base_fenqi_remark_num");
                                break;
                            case "one_year":
                                setListAndAdaper(base_list_one_year,"base_fenqi_remark_num");
                                break;
                        }
                        break;
                     case "拒绝业务数量降序" :
                        choosen_sort=base_fenqi_refuse_num;
                        switch (choosen_time){
                            case "one_week":
                            ...
                            case "one_month":
                                ...
                                break;
                            case "three_month":
                                setListAndAdaper(base_list_three_month,"base_fenqi_refuse_num");
                                break;
                            case "one_year":
                                setListAndAdaper(base_list_one_year,"base_fenqi_refuse_num");
                                break;
                        }
                        break;
                    case "成功业务数量降序" :
