...
public class KSubManager4sManagementDetailActivity extends AppCompatActivity {
    ...
    void initDatas(){
        spu = new SharePreferenceUtil(KSubManager4sManagementDetailActivity.this,"user");
    ...
    void getDataFormServer(){
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 0 :
                        try {
                            ...
                            if (reCode!=null){
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(KSubManager4sManagementDetailActivity.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    adapter = new BasePerfDetailAdapter(worker_list_one_week,KSubManager4sManagementDetailActivity.this);
                                    ...
                                    Log.e("KMyPreformenceActivity", KSubManager4sManagementDetailActivity.this.getResources().getString(R.string.status_exception));
                                }
                            }
                            else {
                                Toast.makeText(KSubManager4sManagementDetailActivity.this, KSubManager4sManagementDetailActivity.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    default:
                        Log.e("KMyPreformenceActivity", KSubManager4sManagementDetailActivity.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
        ...
        new Thread(){
            ...
            public void run() {
                ...
                params[0] = new PostParameter("id", worker_account);
                String reCode = ConnectUtil.httpRequest(ConnectUtil.GetSecondaryInsWorkerPerformance, params, ConnectUtil.POST);
                Log.e("reCode",""+reCode);
