...
public class KSubManagerPerformanceActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ksubmanager_performance_2);
    ...
    void initDatas(){
        spu = new SharePreferenceUtil(KSubManagerPerformanceActivity2.this, "user");
        select_string = new String[]{"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, KSubManagerPerformanceActivity2.this);
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList,KSubManagerPerformanceActivity2.this);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 0 :
                        try {
                            ...
                            if (reCode!=null){
                                ...
                                if ("false".equals(status)) {
                                    Toast.makeText(KSubManagerPerformanceActivity2.this, json.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    adapter = new BasePerfAdapter(base_list_one_week, KSubManagerPerformanceActivity2.this);
                                    ...
                                    Log.e("KMyPreformenceActivity", KSubManagerPerformanceActivity2.this.getResources().getString(R.string.status_exception));
                                }
                            }
                            else {
                                Toast.makeText(KSubManagerPerformanceActivity2.this, KSubManagerPerformanceActivity2.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        ...
                        break;
                    default:
                        Log.e("KMyPreformenceActivity", KSubManagerPerformanceActivity2.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
    ...
    void initEvents(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(KSubManagerPerformanceActivity2.this,K4SShopPerformanceActivity.class);
    ...
    void showSortPopWindow(){
        View root = LayoutInflater.from(KSubManagerPerformanceActivity2.this).inflate(R.layout.choose_time_listview,null);
