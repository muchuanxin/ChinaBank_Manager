...
public class LobbyErjiPerformanceListAdapter extends BaseAdapter {
    private List<LobbyErjiVO> list;
    private Context context;
    private LayoutInflater inflater;

    public LobbyErjiPerformanceListAdapter(List<LobbyErjiVO> list, Context context) {
        this.list = list;
        this.context = context;
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public List<LobbyErjiVO> getList() {
        return list;
    }
    public void setList(List<LobbyErjiVO> list) { this.list = list;}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_name.setText(list.get(position).getSecondary_name());
