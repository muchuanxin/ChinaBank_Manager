...
public class ProvinceManagerCardDivErjiPerformance extends AppCompatActivity {
    ...
    private List<LobbyErjiVO> lobby_erji_list_one_week = new ArrayList<>();
    private List<LobbyErjiVO> lobby_erji_list_one_month = new ArrayList<>();
    private List<LobbyErjiVO> lobby_erji_list_three_month = new ArrayList<>();
    private List<LobbyErjiVO> lobby_erji_list_one_year = new ArrayList<>();
    private List<LobbyErjiVO> list = new ArrayList<>();

    private LobbyErjiPerformanceListAdapter adapter;
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerCardDivErjiPerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                                ...
                                if(oneWeekJA.length() > 0) {
                                    for(int i = 0; i < oneWeekJA.length(); i++) {
                                        ...
                                        LobbyErjiVO LobbyErjiVO = new LobbyErjiVO();
                                        LobbyErjiVO.setSecondary_num(temp.getString("secondary_num"));
                                        LobbyErjiVO.setSecondary_name(temp.getString("secondary_name"));
                                        LobbyErjiVO.setRecommend_num(temp.getInt("recommend_num"));
                                        LobbyErjiVO.setSuccess_num(temp.getInt("success_num"));

//                                        Log.e("LobbyPerformance", i + "");

                                        lobby_erji_list_one_week.add(LobbyErjiVO);
                                        list = lobby_erji_list_one_week;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        lobby_erji_list_one_month.add(LobbyErjiVO);
                                        list = lobby_erji_list_one_month;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        lobby_erji_list_three_month.add(LobbyErjiVO);
                                        list = lobby_erji_list_three_month;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        lobby_erji_list_one_year.add(LobbyErjiVO);
                                        list = lobby_erji_list_one_year;
                                    }
                                }
                                //默认显示一周业绩
                                adapter = new LobbyErjiPerformanceListAdapter(lobby_erji_list_one_week, ProvinceManagerCardDivErjiPerformance.this);
                                listView.setAdapter(adapter);
                                if(lobby_erji_list_one_week.size() > 0) {
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerCardDivErjiPerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerCardDivErjiPerformance.this, ProvinceManagerCardDivErjiPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerCardDivErjiPerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_card_div_erji_performance);
    ...
    void initDatas() {
        spu = new SharePreferenceUtil(ProvinceManagerCardDivErjiPerformance.this, "user");
        select_sort_string = new String[] {"推荐办卡数量降序", "成功办卡数量降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.lobbyChooseSortList, ProvinceManagerCardDivErjiPerformance.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerCardDivErjiPerformance.this);
    ...
    void initEvents() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ProvinceManagerCardDivErjiPerformance.this, ProvinceManagerCardDivManagerPerformance.class);
...
//    }
    ...
    void setListAndAdaper(List<LobbyErjiVO> list, String name){
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerCardDivErjiPerformance.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_card_div_erji_performance), Gravity.TOP, 0, 0);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseSortList.get(position)) {
                    case "推荐办卡数量降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(lobby_erji_list_one_week, "reocmmend_num");
                                break;

                            case "one_month":
                                setListAndAdaper(lobby_erji_list_one_month, "reocmmend_num");
                                break;

                            case "three_month":
                                setListAndAdaper(lobby_erji_list_three_month, "reocmmend_num");
                                break;

                            case "one_year":
                                setListAndAdaper(lobby_erji_list_one_year, "reocmmend_num");
                                break;
                        }
                        break;
                    ...
                    case "成功办卡数量降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(lobby_erji_list_one_week, "success_num");
                                break;

                            case "one_month":
                                setListAndAdaper(lobby_erji_list_one_month, "success_num");
                                break;

                            case "three_month":
                                setListAndAdaper(lobby_erji_list_three_month, "success_num");
                                break;

                            case "one_year":
                                setListAndAdaper(lobby_erji_list_one_year, "success_num");
                                break;
                        }
                        break;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseTimeList.get(position)){
                    case "近一周业绩" :
                        ...
                        switch (choosen_sort){
                            case "reocmmend_num":
                                ListUtils.sort(lobby_erji_list_one_week,false,"reocmmend_num");
                                adapter.setList(lobby_erji_list_one_week);
                                adapter.notifyDataSetChanged();
                                break;
                            case "success_num":
                                setListAndAdaper(lobby_erji_list_one_week,"success_num");
