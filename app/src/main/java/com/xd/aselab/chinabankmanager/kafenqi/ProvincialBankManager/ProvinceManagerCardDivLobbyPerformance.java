...
public class ProvinceManagerCardDivLobbyPerformance extends AppCompatActivity {
    ...
    private List<LobbyVO> list = new ArrayList<>();
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerCardDivLobbyPerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        list = lobby_list_one_year;
                                    }
                                }
                                //默认显示一周业绩
                                adapter = new LobbyPerformanceListAdapter(lobby_list_one_week, ProvinceManagerCardDivLobbyPerformance.this);
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerCardDivLobbyPerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerCardDivLobbyPerformance.this, ProvinceManagerCardDivLobbyPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerCardDivLobbyPerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_card_div_lobby_performance);
    ...
    void initDatas() {
        erji_num = getIntent().getStringExtra("erji_num");
        spu = new SharePreferenceUtil(ProvinceManagerCardDivLobbyPerformance.this, "user");
        select_sort_string = new String[] {"推荐办卡数量降序", "成功办卡数量降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.lobbyChooseSortList, ProvinceManagerCardDivLobbyPerformance.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerCardDivLobbyPerformance.this);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                parameters[0] = new PostParameter("erji_num", erji_num);
...
//                intent.setClass(ProvinceManagerCardDivLobbyPerformance.this, LobbyPerformanceContactTransparent.class);
...
//    }
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerCardDivLobbyPerformance.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_card_div_lobby_performance), Gravity.TOP, 0, 0);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseSortList.get(position)) {
                    case "推荐办卡数量降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(lobby_list_one_week, "reocmmend_num");
                                break;

                            case "one_month":
                                setListAndAdaper(lobby_list_one_month, "reocmmend_num");
                                break;

                            case "three_month":
                                setListAndAdaper(lobby_list_three_month, "reocmmend_num");
                                break;

                            case "one_year":
                                setListAndAdaper(lobby_list_one_year, "reocmmend_num");
                                break;
                        }
                        break;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseTimeList.get(position)){
                    case "近一周业绩" :
                        ...
                        switch (choosen_sort){
                            case "reocmmend_num":
                                ListUtils.sort(lobby_list_one_week,false,"reocmmend_num");
