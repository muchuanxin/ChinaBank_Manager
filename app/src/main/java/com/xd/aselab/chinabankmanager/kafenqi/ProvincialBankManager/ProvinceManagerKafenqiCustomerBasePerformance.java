...
public class ProvinceManagerKafenqiCustomerBasePerformance extends AppCompatActivity {
    ...
    private List<NonCarBaseVO> erjibase_list_one_week = new ArrayList<>();
    private List<NonCarBaseVO> erjibase_list_one_month = new ArrayList<>();
    private List<NonCarBaseVO> erjibase_list_three_month = new ArrayList<>();
    private List<NonCarBaseVO> erjibase_list_one_year = new ArrayList<>();
    private List<NonCarBaseVO> list = new ArrayList<>();
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerKafenqiCustomerBasePerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjibase_list_one_week.add(NonCarBaseVO);
                                        list = erjibase_list_one_week;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjibase_list_one_month.add(NonCarBaseVO);
                                        list = erjibase_list_one_month;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjibase_list_three_month.add(NonCarBaseVO);
                                        list = erjibase_list_three_month;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjibase_list_one_year.add(NonCarBaseVO);
                                        list = erjibase_list_one_year;
                                    }
                                }
                                //默认显示一周业绩
                                adapter = new NonCarBasePerfListAdapter(erjibase_list_one_week, ProvinceManagerKafenqiCustomerBasePerformance.this);
                                listView.setAdapter(adapter);
                                if(erjibase_list_one_week.size() > 0) {
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiCustomerBasePerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerKafenqiCustomerBasePerformance.this, ProvinceManagerKafenqiCustomerBasePerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiCustomerBasePerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_kafenqi_customer_base_performance);
    ...
    void initDatas() {
        branch_sub_id = getIntent().getStringExtra("branch_sub_id");
        spu = new SharePreferenceUtil(ProvinceManagerKafenqiCustomerBasePerformance.this, "user");
        select_sort_string = new String[] {"成功业务数降序", "成功金额数降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList, ProvinceManagerKafenqiCustomerBasePerformance.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerKafenqiCustomerBasePerformance.this);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                parameters[0] = new PostParameter("branch_sub_id", branch_sub_id);
                String recode = ConnectUtil.httpRequest(ConnectUtil.GetYoukeBasicPerformance, parameters, ConnectUtil.POST);
                Log.e("recode",""+recode);
...
//                intent.setClass(ProvinceManagerKafenqiCustomerBasePerformance.this, LobbyPerformanceContactTransparent.class);
...
//    }
    ...
    void setListAndAdaper(List<NonCarBaseVO> list, String name){
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerKafenqiCustomerBasePerformance.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_kafenqi_customer_base_performance), Gravity.TOP, 0, 0);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseSortList.get(position)) {
                    case "成功业务数降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(erjibase_list_one_week, "number");
                                break;

                            case "one_month":
                                setListAndAdaper(erjibase_list_one_month, "number");
                                break;

                            case "three_month":
                                setListAndAdaper(erjibase_list_three_month, "number");
                                break;

                            case "one_year":
                                setListAndAdaper(erjibase_list_one_year, "number");
                                break;
                        }
                        break;
                    ...
                    case "成功金额数降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(erjibase_list_one_week, "money");
                                break;

                            case "one_month":
                                setListAndAdaper(erjibase_list_one_month, "money");
                                break;

                            case "three_month":
                                setListAndAdaper(erjibase_list_three_month, "money");
                                break;

                            case "one_year":
                                setListAndAdaper(erjibase_list_one_year, "money");
                                break;
                        }
                        break;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseTimeList.get(position)){
                    case "近一周业绩" :
                        ...
                        switch (choosen_sort){
                            case "number":
                                ListUtils.sort(erjibase_list_one_week,false,"number");
                                adapter.setList(erjibase_list_one_week);
                                adapter.notifyDataSetChanged();
                                break;
                            case "money":
                                setListAndAdaper(erjibase_list_one_week,"money");
