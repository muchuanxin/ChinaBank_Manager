...
public class ProvinceManagerKafenqiCustomerManagerPerformance extends AppCompatActivity {
    ...
    private List<ErjiManagerVO> erjimanager_list_one_week = new ArrayList<>();
    private List<ErjiManagerVO> erjimanager_list_one_month = new ArrayList<>();
    private List<ErjiManagerVO> erjimanager_list_three_month = new ArrayList<>();
    private List<ErjiManagerVO> erjimanager_list_one_year = new ArrayList<>();
    private List<ErjiManagerVO> list = new ArrayList<>();

    private ErjiManagerPerformanceListAdapter adapter;
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerKafenqiCustomerManagerPerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                                ...
                                if(oneWeekJA.length() > 0) {
                                    for(int i = 0; i < oneWeekJA.length(); i++) {
                                        ...
                                        ErjiManagerVO ErjiManagerVO = new ErjiManagerVO();
                                        ErjiManagerVO.setAccount(temp.getString("account"));
                                        ErjiManagerVO.setName(temp.getString("name"));
                                        ErjiManagerVO.setBranch_sub_id(temp.getInt("branch_sub_id"));
                                        ErjiManagerVO.setNumber(temp.getInt("number"));
                                        ErjiManagerVO.setMoney(temp.getDouble("money"));

//                                        Log.e("LobbyPerformance", i + "");

                                        erjimanager_list_one_week.add(ErjiManagerVO);
                                        list = erjimanager_list_one_week;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjimanager_list_one_month.add(ErjiManagerVO);
                                        list = erjimanager_list_one_month;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjimanager_list_three_month.add(ErjiManagerVO);
                                        list = erjimanager_list_three_month;
                                    }
                                }
...
//                                        Log.e("LobbyPerformance", i + "");
                                        ...
                                        erjimanager_list_one_year.add(ErjiManagerVO);
                                        list = erjimanager_list_one_year;
                                    }
                                }
                                //默认显示一周业绩
                                adapter = new ErjiManagerPerformanceListAdapter(erjimanager_list_one_week, ProvinceManagerKafenqiCustomerManagerPerformance.this);
                                listView.setAdapter(adapter);
                                if(erjimanager_list_one_week.size() > 0) {
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiCustomerManagerPerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerKafenqiCustomerManagerPerformance.this, ProvinceManagerKafenqiCustomerManagerPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiCustomerManagerPerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_kafenqi_customer_manager_performance);
    ...
    void initDatas() {
        ...
        spu = new SharePreferenceUtil(ProvinceManagerKafenqiCustomerManagerPerformance.this, "user");
        select_sort_string = new String[] {"成功业务数降序", "成功金额数降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList, ProvinceManagerKafenqiCustomerManagerPerformance.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerKafenqiCustomerManagerPerformance.this);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String recode = ConnectUtil.httpRequest(ConnectUtil.GetYoukeBossManagerPerformace, parameters, ConnectUtil.POST);
                Log.e("recode",""+recode);
    ...
    void initEvents() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("branch_sub_id", list.get(position).getBranch_sub_id());
                intent.setClass(ProvinceManagerKafenqiCustomerManagerPerformance.this, ProvinceManagerKafenqiCustomerBasePerformance.class);
...
//    }
    ...
    void setListAndAdaper(List<ErjiManagerVO> list, String name){
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerKafenqiCustomerManagerPerformance.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_kafenqi_customer_manager_performance), Gravity.TOP, 0, 0);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseSortList.get(position)) {
                    case "成功业务数降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(erjimanager_list_one_week, "number");
                                break;

                            case "one_month":
                                setListAndAdaper(erjimanager_list_one_month, "number");
                                break;

                            case "three_month":
                                setListAndAdaper(erjimanager_list_three_month, "number");
                                break;

                            case "one_year":
                                setListAndAdaper(erjimanager_list_one_year, "number");
                                break;
                        }
                        break;
                    ...
                    case "成功金额数降序":
                        ...
                        switch (choosen_time) {
                            case "one_week":
                                setListAndAdaper(erjimanager_list_one_week, "money");
                                break;

                            case "one_month":
                                setListAndAdaper(erjimanager_list_one_month, "money");
                                break;

                            case "three_month":
                                setListAndAdaper(erjimanager_list_three_month, "money");
                                break;

                            case "one_year":
                                setListAndAdaper(erjimanager_list_one_year, "money");
                                break;
                        }
                        break;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (Constants.chooseTimeList.get(position)){
                    case "近一周业绩" :
                        ...
                        switch (choosen_sort){
                            case "number":
                                ListUtils.sort(erjimanager_list_one_week,false,"number");
                                adapter.setList(erjimanager_list_one_week);
                                adapter.notifyDataSetChanged();
                                break;
                            case "money":
                                setListAndAdaper(erjimanager_list_one_week,"money");
