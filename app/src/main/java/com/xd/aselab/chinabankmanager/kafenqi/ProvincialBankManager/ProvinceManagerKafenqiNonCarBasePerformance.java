...
public class ProvinceManagerKafenqiNonCarBasePerformance extends AppCompatActivity {
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerKafenqiNonCarBasePerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                        Log.e("LobbyPerformance", i + "");
                                ...
                                //默认显示一周业绩
                                adapter = new NonCarBasePerfListAdapter(erjibase_list_one_week, ProvinceManagerKafenqiNonCarBasePerformance.this);
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiNonCarBasePerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerKafenqiNonCarBasePerformance.this, ProvinceManagerKafenqiNonCarBasePerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiNonCarBasePerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_kafenqi_non_car_base_performance);
    ...
    void initDatas() {
        ...
        spu = new SharePreferenceUtil(ProvinceManagerKafenqiNonCarBasePerformance.this, "user");
        select_sort_string = new String[] {"成功业务数降序", "成功金额数降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList, ProvinceManagerKafenqiNonCarBasePerformance.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerKafenqiNonCarBasePerformance.this);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                parameters[0] = new PostParameter("secondary_num", branch_sub_id);
...
//                intent.setClass(ProvinceManagerKafenqiNonCarBasePerformance.this, LobbyPerformanceContactTransparent.class);
...
//    }
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerKafenqiNonCarBasePerformance.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_kafenqi_base_performance), Gravity.TOP, 0, 0);
