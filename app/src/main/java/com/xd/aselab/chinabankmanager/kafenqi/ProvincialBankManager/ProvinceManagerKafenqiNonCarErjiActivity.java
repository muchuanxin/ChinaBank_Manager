...
public class ProvinceManagerKafenqiNonCarErjiActivity extends AppCompatActivity {
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerKafenqiNonCarErjiActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                        Log.e("LobbyPerformance", i + "");
                                ...
                                //默认显示一周业绩
                                adapter = new ErjiPerformanceListAdapter(erji_list_one_week, ProvinceManagerKafenqiNonCarErjiActivity.this);
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiNonCarErjiActivity.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerKafenqiNonCarErjiActivity.this, ProvinceManagerKafenqiNonCarErjiActivity.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiNonCarErjiActivity.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_kafenqi_non_car_erji_performance);
    ...
    void initDatas() {
        spu = new SharePreferenceUtil(ProvinceManagerKafenqiNonCarErjiActivity.this, "user");
        select_sort_string = new String[] {"成功业务数降序", "成功金额数降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList, ProvinceManagerKafenqiNonCarErjiActivity.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerKafenqiNonCarErjiActivity.this);
...
//                parameters[0] = new PostParameter("erji_num", spu.getBranchLevel2());
                String recode = ConnectUtil.httpRequest(ConnectUtil.GetNotCarSecondaryBankPerformace, parameters, ConnectUtil.POST);
                Log.e("recode",""+recode);
    ...
    void initEvents() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ProvinceManagerKafenqiNonCarErjiActivity.this, ProvinceManagerKafenqiNonCarManagerPerformance.class);
...
//    }
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerKafenqiNonCarErjiActivity.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_kafenqi_non_car), Gravity.TOP, 0, 0);
