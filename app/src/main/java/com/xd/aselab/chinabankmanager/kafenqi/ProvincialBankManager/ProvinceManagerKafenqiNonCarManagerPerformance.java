...
public class ProvinceManagerKafenqiNonCarManagerPerformance extends AppCompatActivity {
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ProvinceManagerKafenqiNonCarManagerPerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                        Log.e("LobbyPerformance", i + "");
                                ...
                                //默认显示一周业绩
                                adapter = new ErjiManagerPerformanceListAdapter(erjimanager_list_one_week, ProvinceManagerKafenqiNonCarManagerPerformance.this);
                                ...
                                Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiNonCarManagerPerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ProvinceManagerKafenqiNonCarManagerPerformance.this, ProvinceManagerKafenqiNonCarManagerPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ProvinceManagerNonCar", ProvinceManagerKafenqiNonCarManagerPerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_province_manager_kafenqi_non_car_manager_performance);
    ...
    void initDatas() {
        ...
        spu = new SharePreferenceUtil(ProvinceManagerKafenqiNonCarManagerPerformance.this, "user");
        select_sort_string = new String[] {"成功业务数降序", "成功金额数降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseSortAdapter = new ChooseSortAdapter(Constants.shengHangChooseSortList, ProvinceManagerKafenqiNonCarManagerPerformance.this);
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ProvinceManagerKafenqiNonCarManagerPerformance.this);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String recode = ConnectUtil.httpRequest(ConnectUtil.GetNotCarBossManagerPerformace, parameters, ConnectUtil.POST);
                Log.e("recode",""+recode);
    ...
    void initEvents() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ProvinceManagerKafenqiNonCarManagerPerformance.this, ProvinceManagerKafenqiNonCarBasePerformance.class);
...
//    }
    ...
    void showSortPopWindow() {
        View root = LayoutInflater.from(ProvinceManagerKafenqiNonCarManagerPerformance.this).inflate(R.layout.choose_time_listview, null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_province_manager_kafenqi_manager_performance), Gravity.TOP, 0, 0);
