...
public class ErjiKafenqiCustomerBasePerformance extends AppCompatActivity {
                    ...
                    try {
                        ...
                        if(recode != null) {
                            ...
                            if("false".equals(status)) {
                                Toast.makeText(ErjiKafenqiCustomerBasePerformance.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
...
//                                        Log.e("LobbyPerformance", i + "");
                                ...
                                //默认显示一周业绩
                                adapter = new NonCarBasePerfListAdapter(non_car_base_one_week, ErjiKafenqiCustomerBasePerformance.this);
                                ...
                                Log.e("ErjiKafenqiCustomerBase", ErjiKafenqiCustomerBasePerformance.this.getResources().getString(R.string.status_exception));
                            }
                        }
                        else {
                            Toast.makeText(ErjiKafenqiCustomerBasePerformance.this, ErjiKafenqiCustomerBasePerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                default:
                    Log.e("ErjiKafenqiCustomerBase", ErjiKafenqiCustomerBasePerformance.this.getResources().getString(R.string.handler_what_exception));
                    break;
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_erji_kafenqi_customer_base_performance);
    ...
    void initViews() {
        back = (RelativeLayout) findViewById(R.id.act_erji_kafenqi_customer_base_performance_back_btn);
...
//        choose_sort = (LinearLayout) findViewById(R.id.perfRanking);
    ...
    void initDatas() {
        spu = new SharePreferenceUtil(ErjiKafenqiCustomerBasePerformance.this, "user");
//        select_sort_string = new String[] {"推荐办卡数量降序", "成功办卡数量降序"};
        select_time_string = new String[] {"近一周业绩", "近一月业绩", "近一季度业绩", "近一年业绩"};
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList, ErjiKafenqiCustomerBasePerformance.this);
...
//    }
    ...
    void showTimePopWindow() {
        View root = LayoutInflater.from(ErjiKafenqiCustomerBasePerformance.this).inflate(R.layout.choose_time_listview,null);
        ListView lv_timeList = (ListView)root.findViewById(R.id.choose_time_listview) ;
        ...
        pop.showAsDropDown(select_time);
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_erji_kafenqi_customer_base_performance), Gravity.TOP, 0, 0);
