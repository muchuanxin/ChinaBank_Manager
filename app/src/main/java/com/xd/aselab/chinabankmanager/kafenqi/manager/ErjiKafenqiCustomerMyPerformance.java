...
public class ErjiKafenqiCustomerMyPerformance extends AppCompatActivity implements OnChartValueSelectedListener {

    private TextView erji_non_car_success_num;
    private TextView erji_non_car_success_money;
    ...
    private int success_num_one_week;
    private double success_money_one_week;
    private int success_num_one_month;
    private double success_money_one_month;
    private int success_num_three_month;
    private double success_money_three_month;
    private int success_num_one_year;
    private double success_money_one_year;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_erji_kafenqi_customer_my_performance);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        }

        back = (RelativeLayout) findViewById(R.id.act_erji_kafenqi_customer_my_perf_back_btn);
        ...
        erji_non_car_success_num = (TextView) findViewById(R.id.act_erji_kafenqi_customer_my_perf_success_num_text);
        erji_non_car_success_money = (TextView) findViewById(R.id.act_erji_kafenqi_customer_my_perf_success_money_text);
        ll_chart = (LinearLayout) findViewById(R.id.ll_chart);
        ll_no_data = (LinearLayout) findViewById(R.id.ll_no_data);
        rl_select_time = (RelativeLayout) findViewById(R.id.rl_customer_my_perf_select_time);

        select_time = (TextView) findViewById(R.id.act_customer_my_perf_select_time);
        gray_bar_top = (RelativeLayout)findViewById(R.id.act_erji_kafenqi_customer_my_perf_gray_bar_top);
        gray_bar = (TextView)findViewById(R.id.act_erji_kafenqi_customer_my_perf_gray_bar);
    ...
    void getData() {
        new Thread() {
            ...
            public void run() {
                super.run();
                SharePreferenceUtil spu = new SharePreferenceUtil(ErjiKafenqiCustomerMyPerformance.this, "user");
                PostParameter[] parameter = new PostParameter[1];
                parameter[0] = new PostParameter("account", spu.getAccount());
                String recode = ConnectUtil.httpRequest(ConnectUtil.GetYoukeBossMyPerformance, parameter, ConnectUtil.POST);
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                        ...
                        try {
                            ...
                            if(recode != null) {
                                ...
                                if("false".equals(status)) {
                                    Toast.makeText(ErjiKafenqiCustomerMyPerformance.this, object.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    Log.e("KMyPreformenceActivity", ErjiKafenqiCustomerMyPerformance.this.getResources().getString(R.string.status_exception));
                                }
                            } else {
                                Toast.makeText(ErjiKafenqiCustomerMyPerformance.this, ErjiKafenqiCustomerMyPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                    ...
                    default:
                        Log.e("KMyPreformenceActivity", ErjiKafenqiCustomerMyPerformance.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
    ...
    void initDatas() {
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList,ErjiKafenqiCustomerMyPerformance.this);
    }
...
//                intent.setClass(KafenqiCustomerPerformance.this, KafenqiCustomerPerformanceDetial.class);
...
//        });
    ...
    void showPopWindow() {
        View root = LayoutInflater.from(ErjiKafenqiCustomerMyPerformance.this).inflate(R.layout.choose_time_listview,null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_erji_kafenqi_customer_my_performance), Gravity.TOP, 0, 0);
    ...
    private void setText(int success_num,double success_money) {
        ...
        erji_non_car_success_num.setText(("".equals(success_num)? "暂无" : success_num) + "笔");
        erji_non_car_success_money.setText(("".equals(success_money)? "暂无" : df.format(success_money))+"万元");
//
//        if(recommend_num==0){
