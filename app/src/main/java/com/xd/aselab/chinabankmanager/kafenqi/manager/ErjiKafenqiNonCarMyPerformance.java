...
public class ErjiKafenqiNonCarMyPerformance extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_erji_kafenqi_non_car_my_performance);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        }

        back = (RelativeLayout) findViewById(R.id.act_erji_kafenqi_non_car_my_perf_back_btn);
        ...
        erji_non_car_success_num = (TextView) findViewById(R.id.act_erji_kafenqi_non_car_my_perf_success_num_text);
        erji_non_car_success_money = (TextView) findViewById(R.id.act_erji_kafenqi_non_car_my_perf_success_money_text);
        ll_chart = (LinearLayout) findViewById(R.id.ll_chart);
        ll_no_data = (LinearLayout) findViewById(R.id.ll_no_data);
        rl_select_time = (RelativeLayout) findViewById(R.id.rl_non_car_my_perf_select_time);

        select_time = (TextView) findViewById(R.id.act_non_car_my_perf_select_time);
        gray_bar_top = (RelativeLayout)findViewById(R.id.act_erji_kafenqi_non_car_my_perf_gray_bar_top);
        gray_bar = (TextView)findViewById(R.id.act_erji_kafenqi_non_car_my_perf_gray_bar);
    ...
    void getData() {
        new Thread() {
            ...
            public void run() {
                super.run();
                SharePreferenceUtil spu = new SharePreferenceUtil(ErjiKafenqiNonCarMyPerformance.this, "user");
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                        ...
                        try {
                            ...
                            if(recode != null) {
                                ...
                                if("false".equals(status)) {
                                    Toast.makeText(ErjiKafenqiNonCarMyPerformance.this, object.getString("message"), Toast.LENGTH_SHORT).show();
                                    ...
                                    Log.e("KMyPreformenceActivity", ErjiKafenqiNonCarMyPerformance.this.getResources().getString(R.string.status_exception));
                                }
                            } else {
                                Toast.makeText(ErjiKafenqiNonCarMyPerformance.this, ErjiKafenqiNonCarMyPerformance.this.getResources().getString(R.string.network_connect_exception), Toast.LENGTH_SHORT).show();
                    ...
                    default:
                        Log.e("KMyPreformenceActivity", ErjiKafenqiNonCarMyPerformance.this.getResources().getString(R.string.handler_what_exception));
                        break;
                }
            }
        };
    ...
    void initDatas() {
        chooseTimeAdapter = new ChooseTimeAdapter(Constants.chooseTimeList,ErjiKafenqiNonCarMyPerformance.this);
    }
...
//        });
    ...
    void showPopWindow() {
        View root = LayoutInflater.from(ErjiKafenqiNonCarMyPerformance.this).inflate(R.layout.choose_time_listview,null);
        ...
        // 在顶部显示
        pop.showAtLocation(findViewById(R.id.activity_erji_kafenqi_non_car_my_performance), Gravity.TOP, 0, 0);
