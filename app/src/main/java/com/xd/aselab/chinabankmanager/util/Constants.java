...
public class Constants {
    ...
    public static String uploadGrabFacePhoto = ConnectUtil.GrabBusinessFaceForAndroid + "?";
    ...
    public static List<String> lobbyChooseSortList = new ArrayList<String>(Arrays.asList("推荐办卡数量降序", "成功办卡数量降序"));
